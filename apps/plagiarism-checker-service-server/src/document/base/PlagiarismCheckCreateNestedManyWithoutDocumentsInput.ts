...
@InputType()
class PlagiarismCheckCreateNestedManyWithoutDocumentsInput {
...
export { PlagiarismCheckCreateNestedManyWithoutDocumentsInput as PlagiarismCheckCreateNestedManyWithoutDocumentsInput };
