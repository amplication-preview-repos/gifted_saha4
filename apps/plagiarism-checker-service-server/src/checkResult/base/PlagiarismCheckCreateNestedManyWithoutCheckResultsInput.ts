...
@InputType()
class PlagiarismCheckCreateNestedManyWithoutCheckResultsInput {
...
export { PlagiarismCheckCreateNestedManyWithoutCheckResultsInput as PlagiarismCheckCreateNestedManyWithoutCheckResultsInput };
